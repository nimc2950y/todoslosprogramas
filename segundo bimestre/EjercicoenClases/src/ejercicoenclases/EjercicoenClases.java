...
public class EjercicoenClases {
    public static void main(String[] args) {
        
        int size = 100; // el tama;o de cuantos numeros de van a mostrar 

        // Arreglo para almacenar los datos aleatorios
        int[] arr = new int[size];

        Random random = new Random();
        for (int i = 0; i < size; i++) {
            arr[i] = random.nextInt(100) + 1; // Genera un número aleatorio entre 1 y 500
        }
